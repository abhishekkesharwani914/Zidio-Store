...
const SignPage = () => {
  ...
  return (
    <div className="flex justify-center text-white md:h-[calc(100vh-130px)] h-[calc(100vh-80px)]">
      {/* Main container */}
        ...
        <div className="w-1/2 h-full relative overflow-hidden hidden sm:block">
          ...
          <div className="absolute inset-0 bg-black/20 flex items-center justify-center">
            <h2 className="text-white text-xl font-bold text-center px-4">
              Welcome to <br />{" "}
              <span className="text-3xl rubik-glitch">DUKE & VILLAN</span>
            </h2>
          </div>
        </div>

        {/* Right side - Form */}
        <div className="sm:w-1/2 w-full h-full bg-black p-8 md:p-24 flex flex-col justify-center border-r border-t border-b border-gray-800">
